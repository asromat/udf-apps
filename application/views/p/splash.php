...
<div class="hero-block-wrapper bg-primary">
    ...
    <div class="custom-container">
        ...
        <div class="hero-block-content">
            ...
            <h2 class="display-4 text-white mb-3">Know Yourself, Learn What You Love</h2>
            <p class="text-white">Knowledge Management System memungkinkan kamu belajar sesuai dengan kemampuan dan keinginanmu.</p>
